...
def builModel ():
    ...
    model.add(layers.Conv1D(128, 3,activation='relu',input_shape=(512, 1)))
...
model.fit(embeddings_train,data_train.labels,epochs=50,validation_data=(embeddings_test,data_test.labels),batch_size=80,verbose=1)   
